...
# Los subtítulos tienen parent="" (sin nodo raíz explícito).
# Con branchvalues="total", un nodo raíz con value=0 hace que Plotly
# no renderice nada. Omitirlo es la solución correcta.
sub_totales: dict = {}
